function makeMachineFolders(kathara, lab) {
	for (let machine of kathara)
		lab.folders.push(machine.name);
}

function makeStartupFiles(kathara, lab) {
	for (let machine of kathara) {
...
function makeLabConfFile(kathara, lab) {
...
function makeTerminal(kathara, lab) {
	for (let machine of kathara) {
...
function makeWebserver(kathara, lab) {
	for (let machine of kathara) {
...
function makeOther(kathara, lab) {
	for (let machine of kathara) {
...
function makeNameserver(kathara, lab) {
	//Gestione Nameserver
...
function makeRouter(kathara, lab) {
...
function makeOVSwitch(kathara, lab) {
	for (let machine of kathara) {
...
function makeRyuController(kathara, lab) {
	let isSDN = false;
	for (let machine of kathara) {
...
function makeStaticRouting(kathara, lab) {
...
function makeFilesStructure(kathara, labInfo) {
	...
	makeMachineFolders(kathara, lab);
	makeLabConfFile(kathara, lab);
	makeStartupFiles(kathara, lab);
	makeStaticRouting(kathara, lab);
	makeTerminal(kathara, lab);
	makeRouter(kathara, lab);
	makeWebserver(kathara, lab);
	makeNameserver(kathara, lab);
	makeOther(kathara, lab);
	makeOVSwitch(kathara, lab);
	makeRyuController(kathara, lab);
